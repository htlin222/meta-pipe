...
# (b) the real artifacts produced. The gate is the rhetorical payload: it shows
# exactly where a human / Claude-Code operator must step in. A faithful web UI
# is a *thin shell* around that operator -- which is the whole point of the
# contrast demo.

GATE_NONE = None


def build_stages(proj: Path) -> list[dict]:
    return [
        {
            "id": "00_intake",
            "num": "00",
        ...
        },
        {
            ...
            "summary": "Dual independent screening against PICO; agreement (kappa) reported. Step 8 confirms analysis type.",
            "gate": {
                "type": "decision",
